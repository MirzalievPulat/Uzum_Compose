...
val  Color.Companion.PlainGreenUzum :Color get() =  Color(0xFF9ded70)
...
val  Color.Companion.WhiteBg :Color get() =  Color(0xFFECECEC)
val  Color.Companion.TextField :Color get() =  Color(0xFFEAECEE)
val  Color.Companion.TransparentGray :Color get() =  Color(0x806D6D6F)
val  Color.Companion.DoneBg :Color get() =  Color(0xff6607df)
val  Color.Companion.TransparentGray2 :Color get() =  Color(0xff7748f1)
val  Color.Companion.VeryPlainGray :Color get() =  Color(0xFFE2E1E1)

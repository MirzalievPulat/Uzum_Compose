...
class GetFeeUCImpl @Inject constructor(private val transferRepository: TransferRepository):GetFeeUC {
    override fun invoke(feeForThis: TransferData.FeeForThis): Flow<Result<TransferData.GetFee>>  {
        return  transferRepository.getFee(feeForThis)
    }
}